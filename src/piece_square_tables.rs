//Piece square tables based on https://www.chessprogramming.org/PeSTO%27s_Evaluation_Function

//All my tables must have values > 0 to avoid division by 0
...
pub const KING: [i32; 64] = [
   1,  89,  82,  51,  10,  32,  68,  79, 
  95,  65,  46,  59,  58,  62,  28,  37,
  57,  90,  68,  50,  46,  72,  88,  44,
  49,  46,  54,  39,  36,  41,  52,  30,
  17,  65,  39,  27,  20,  22,  33,  15,
  52,  52,  44,  20,  22,  36,  51,  39,
  67,  73,  58,   2,  23,  50,  75,  74,
  51, 102,  78,  12,  74,  38,  90,  80
];



//Previous evaluation tables I used
